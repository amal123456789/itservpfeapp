...
import 'package:itservpfeapp/datadestinationsql/delete.dart';
import 'package:itservpfeapp/datadestinationsql/update.dart';
import 'dart:convert';
...
class getalldata extends StatefulWidget {
  ...
  class getAllDataState extends State<getalldata> {
    ...
    Future <List<DataDestinationModel>> getDataSource() async {
      var data = await http.get('http://localhost:8383/getalldatadestnew');
...
class DetailPage extends StatelessWidget {
  ...
  deletedatas1(DataDestinationModel datasource) async {
    final url = Uri.parse('http://localhost:8383/deletedatadest');
