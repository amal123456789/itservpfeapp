...
import 'package:itservpfeapp/datadestinationsql/getalldata.dart';
import 'package:itservpfeapp/datadestinationsql/register.dart';
...
class drawerdState extends State<drawerd> with SingleTickerProviderStateMixin {
  //final minimumPadding = 5.0;
  static const List<Tab> myTabs = <Tab>[
    Tab(text: 'Add to data destination ',),
    Tab(text: 'All Data'),
  ];
