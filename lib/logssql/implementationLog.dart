...
Future<Null> selectTimePicker(BuildContext context) async {
  ...
  _addEmployee() {
    ...
    ||/* _iD_DEMController.text.isEmpty || _bPM_UIDController.text.isEmpty ||*/ _rEF_DEM_SRCController.text.isEmpty
    ) {
      print('Empty Fields');
      return;
    }
    _showProgress('Adding Employee...');
    ServicesLogsql.addEmployee(_d_LOGController.text,_tYPEController.text, _sENSController.text,_wSController.text
    ...
    _bPM_UIDController.text*/_rEF_DEM_SRCController.text, context)
        .then((result) {
      if ('success' == result) {
  ...
  _deleteEmployee(LogsModel employee) async {
    final url = Uri.parse('http://localhost:8383/deletelogs');
